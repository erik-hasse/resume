...
Data Scientist and Mathematician with a passion for finding patterns. Experience teaching gives strong oral and written communication skills. Enjoys travel  and astrophotography.
...
Languages & Python, SQL, R, Scala, Haskell\\[5pt]
Python Packages & \begin{tabular}[t]{@{}l@{}}NumPy, Pandas, SciKit-Learn, Matplotlib, Seaborn, BeautifulSoup,\\ TensorFlow, PySpark\end{tabular}\\[18pt]
Machine Learning & \begin{tabular}[t]{@{}l@{}}Linear and Logistic Regression, $k$-Nearest Neighbors, Decision Trees,\\ Gradient Boosting, $k$-Means Clustering,  Neural Networks\end{tabular} \\[18pt]
Other & \begin{tabular}[t]{@{}l@{}}Amazon Web Services, Web Scraping, git, Spark, Linear Algebra,\\ LaTeX, vim, Unix Terminal\end{tabular}
\end{tabular}
